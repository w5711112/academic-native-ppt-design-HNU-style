# -*- coding: utf-8 -*-
r"""
湖南大学专属学术汇报生成脚本 (100% 忠实于《投标文件--技术部分.docx》真实事实)
严格遵循湖大母版规范与零幻觉契约：
...
# 引入引擎
engine_dir = r"C:\Users\w5711112\.agents\skills\academic-native-ppt-design-HNU-style\scripts"
sys.path.insert(0, engine_dir)
from hnu_template_engine import HNUTemplateEngineHNU

base_template = r"C:\Users\w5711112\.agents\skills\academic-native-ppt-design-HNU-style\templates\hnu_base_template.pptx"
output_pptx = r"C:\Users\w5711112\.agents\skills\academic-native-ppt-design-HNU-style\examples\投标文件--技术部分--湖大模板汇报.pptx"
assets_dir = r"C:\Users\w5711112\.agents\skills\academic-native-ppt-design-HNU-style\assets\投标文件--技术部分"
        ...
        "contents": [
            {
                ...
                "dense": True,
                "bullets": [
                    "MBD 模型驱动方法论：以系统模型为核心制品，打通需求分析、顶层设计、模块实现到联调闭环；",
